...
# /renovate:migrate-dependabot — Dependabot から Renovate へ移行
...
- `renovate.json` が既存 → 上書きせず、`/renovate:tune-renovate` での追記を案内。
...
/renovate:migrate-dependabot minor/patch は自動マージ、cooldown 3日、timezone Asia/Tokyo
```
